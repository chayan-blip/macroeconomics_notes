...
- **Positive but diminishing returns**: $$f'(k) > 0, f''(k)  0$$ → capital increases
- **Above $$k^*$$**: Investment falls short of breakeven → $$\dot{k}  n + g$$ → economy overinvests in capital
- **Underinvestment**: $$r < n + g$$ → economy saves too little for optimal long-term consumption
...
# 🌐 International Asset Markets & Exchange Rate Dynamics
